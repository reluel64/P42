...
x86_64-elf-gcc -T linker.ld -o test.bin -ffreestanding -nostdlib interrupts.o bootstrap.o main.o vga.o descriptors.o interrupts_main.o io.o -lgcc -z max-page-size=0x1000
